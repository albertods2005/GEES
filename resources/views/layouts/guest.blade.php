...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="public-shell bg-slate-950 text-slate-100 antialiased">
        @php
            $navigationSections = [
                ['route' => 'public.my-teams', 'title' => 'Mis equipos'],
                ['route' => 'public.trainings', 'title' => 'Entrenamientos'],
                ['route' => 'public.callups', 'title' => 'Convocatorias'],
                ['route' => 'public.fines', 'title' => 'Multas'],
                ['route' => 'public.board', 'title' => 'Pizarra tactica'],
            ];
        @endphp
        ...
        <div class="relative isolate overflow-hidden">
            ...
            <main class="mx-auto max-w-7xl px-6 pb-20 pt-14 lg:px-8 lg:pb-24 lg:pt-18">
